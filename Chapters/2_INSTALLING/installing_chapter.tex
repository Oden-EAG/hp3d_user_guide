...
Applications are implemented in \file{hp3d/trunk/problems/}. A few applications and model problems are provided in the public \hp3D repository and can serve as examples. For example, \file{problems/POISSON/GALERKIN/} is a Galerkin FE implementation for the classical variational Poisson problem. To compile and run the problem, type \code{`make'} in the application folder, i.e.,\\
