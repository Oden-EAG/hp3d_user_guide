...
The starting point for adaptive refiements is an array \var{elem\_ref(:)} of size \var{nr\_elem\_ref} storing a list the middle node numbers (\var{mdle}) corresponding to elements marked for refinement. 
